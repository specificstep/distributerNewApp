...
public class AccountLedgerAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        rowHolder.txt_Adapter_acledger_createddate.setText("Date : " + models.get(position).created_date.trim()); //txt_Adapter_acledger_createddate
        ...
        rowHolder.txt_Adapter_acledger_amount.setText("Amount : " + amount);
        rowHolder.txt_Adapter_acledger_balance.setText("Balance : " + balance);
        if(models.get(position).cr_dr.equals("Credit")) {
            rowHolder.txt_Adapter_acledger_remark.setText("CREDITED FOR " + models.get(position).type + " TO " + models.get(position).particular.toUpperCase());
        } else {
            rowHolder.txt_Adapter_acledger_remark.setText("DEBITED FOR " + models.get(position).type + " FROM " + models.get(position).particular.toUpperCase());
        }
