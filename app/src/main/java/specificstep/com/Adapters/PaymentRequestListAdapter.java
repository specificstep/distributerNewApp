...
import specificstep.com.ui.PaymentRequest.PaymentRequestDetail;
import specificstep.com.ui.PaymentRequest.PaymentRequestListFragment;
    ...
    public void onBindViewHolder(final PaymentRequestListAdapter.MyViewHolder holder, final int listPosition) {
        ...
        holder.lnrPaymentDetail.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String str = new Gson().toJson(requestList.get(listPosition));
                bundle.putString("detail", str);
                PaymentRequestDetail rechargeMainFragment = new PaymentRequestDetail();
