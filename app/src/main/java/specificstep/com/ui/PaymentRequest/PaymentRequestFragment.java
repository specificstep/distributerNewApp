...
import specificstep.com.Models.EnglishNumberToWords;
...
public class PaymentRequestFragment extends BaseFragment {
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        if (homeDelegate != null) {
            homeDelegate.setToolBarTitle(getString(R.string.payment_request));
        }
    }
    ...
    public void onResume() {
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                PaymentRequestListFragment rechargeMainFragment = new PaymentRequestListFragment();
                FragmentManager fragmentManager = getActivity().getSupportFragmentManager();
                FragmentTransaction fragmentTransaction = fragmentManager.beginTransaction();
                fragmentTransaction.add(R.id.fragment_container, rechargeMainFragment).addToBackStack(rechargeMainFragment.toString()+"").commit();
        ...
        adapterPaymentMethod = new ArrayAdapter<String>(getActivity(),
                R.layout.item_spinner_color_text, paymentMethod);
    ...
    public void parseSuccessDepositBankResponse(String response) {
        ...
        System.out.println("Deposit Bank List Response : "+ response );
        ...
        try {
            ...
            if (jsonObject.getString("status").equals("1")) {
                ...
                System.out.println("Deposit Bank List : " + "encrypted_response : " + encrypted_response);
                String decrypted_response = Constants.decryptAPI((Activity) getActivity(), encrypted_response, strMacAddress);

                System.out.println("Deposit Bank List : " + "decrypted_response : " + decrypted_response);
                        ...
                        if (depositBankList.size() > 0) {
                            if(getActivity() != null) {
                                adapterDepositBank = new ArrayAdapter<String>(getActivity(),
                                        R.layout.item_spinner_color_text, depositBankList);
            ...
            System.out.println("Deposit Bank List : " + "Error 4 : " + e.getMessage());
            e.printStackTrace();
        }
    ...
    public void parseSuccessBankResponse(String response) {
        ...
        System.out.println("Bank List Response : " + response);
        ...
        try {
            ...
            if (jsonObject.getString("status").equals("1")) {
                ...
                System.out.println("Bank List : " + "encrypted_response : " + encrypted_response);
                String decrypted_response = Constants.decryptAPI((Activity) getActivity(), encrypted_response, strMacAddress);

                System.out.println("Bank List : " + "decrypted_response : " + decrypted_response);
                    ...
                    try {
                        if (bankList.size() > 0) {
                            adapterBank = new ArrayAdapter<String>(getActivity(),
                                    R.layout.item_spinner_color_text, bankList);
            ...
            System.out.println("Bank List : " + "Error 4 : " + e.getMessage());
            e.printStackTrace();
        }
    ...
    public void parseSuccessWalletResponse(String response) {
        ...
        System.out.println("Wallet Response : " + response);
        ...
        try {
            ...
            if (jsonObject.getString("status").equals("1")) {
                ...
                System.out.println("Wallet : " + "encrypted_response : " + encrypted_response);
                String decrypted_response = Constants.decryptAPI((Activity) getActivity(), encrypted_response, strMacAddress);

                System.out.println("Wallet : " + "decrypted_response : " + decrypted_response);
                ...
                if(wallet.size()>0) {
                    adapterWallet = new ArrayAdapter<String>(getActivity(),
                            R.layout.item_spinner_color_text, wallet);
            ...
            System.out.println("Wallet : " + "Error 4 : " + e.getMessage());
            e.printStackTrace();
        }
